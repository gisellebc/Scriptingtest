...
#In this case, the App Service size will grow.

#Variables(Resource Group, Profile and App Services)
...
# Disabling App Service 1 and growing in size
...
Set-AzAppServicePlan -Name $ServicePlanname1 -ResourceGroupName $ResourceGroupName -Tier P1V2
...
# Disabling App Service 2 and growing in size
...
Set-AzAppServicePlan -Name $ServicePlanname2 -ResourceGroupName $ResourceGroupName -Tier P1V2
...
# Disabling App Service 3 and growing in size
Disable-AzTrafficManagerEndpoint    -ResourceGroupName $ResourceGroupName -ProfileName $ProfileName -Type AzureEndpoints -Force -Name Asia
Set-AzAppServicePlan -Name $ServicePlanname3 -ResourceGroupName $ResourceGroupName -Tier P1V2
